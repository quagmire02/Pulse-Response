...
class Volunteer extends Model
{
    ...
    /**
     * A volunteer who has not reported a position recently is treated as away,
     * the same rule the ambulance fleet uses.
     */
    public const PING_TIMEOUT_SECONDS = 300;

    /** Points earned for attending one incident. */
    public const POINTS_PER_INCIDENT = 10;

    /**
     * Cosmetic perks the points can buy. Kept as a constant rather than a table
     * because the catalogue is small, fixed, and purely presentational.
     *
     * @var array<string, array{name: string, cost: int, type: string, value: string}>
     */
    ...
    /**
     * Volunteers the alert scan may consider: on duty, with a fresh position.
     */
