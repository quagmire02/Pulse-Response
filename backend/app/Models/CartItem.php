...
class CartItem extends Model
{
    ...
    /**
     * Rental days are inclusive of both the start and the end date.
     */
    ...
    /**
     * Resolve the price for this line, falling back to the live catalogue price
     * when no snapshot was stored.
     */
