...
class DatabaseSeeder extends Seeder
{
        public function run(): void
    {
        ...
        $eq1 = \App\Models\Equipment::create([
            ...
            'condition' => 'new',
            'is_available' => true,
            // Rent only: a concentrator is normally hired, not bought outright.
            'is_for_rent' => true,
            'is_for_sale' => false,
        ]);
        $eq2 = \App\Models\Equipment::create([
            ...
            'condition' => 'good',
            'is_available' => true,
            // Rent or buy, so the catalogue exercises both paths.
            'is_for_rent' => true,
            'is_for_sale' => true,
            'sale_price' => 180.00,
        ]);
        $eq3 = \App\Models\Equipment::create([
            ...
            'condition' => 'new',
            'is_available' => true,
            // Sale only, so the buy-without-rent path is covered too.
            'is_for_rent' => false,
            'is_for_sale' => true,
            'sale_price' => 950.00,
        ]);
