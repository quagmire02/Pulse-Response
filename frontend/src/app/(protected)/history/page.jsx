...
export default function HistoryPage() {
  ...
  const [activeTab, setActiveTab] = useState("all") // all, purchase, equipment, consultation, emergency, payment, consultations_list
  ...
  // Doctor Patient List (Consultations)
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Live ambulance position while an emergency is in progress. Renders
          nothing when there is nothing to track. */}
      <AmbulanceTracker />
