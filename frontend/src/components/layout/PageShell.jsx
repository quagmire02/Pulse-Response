...
/**
 * Standard page frame: consistent width, spacing under the fixed navbar, and a
 * header with eyebrow, title, subtitle and actions.
 *
 * Uses the global `pr-` classes from design-system.css rather than a CSS
 * module, so a page can adopt the new look without gaining another stylesheet.
 */
...
/**
 * Normalises the various error shapes the actions layer returns.
 */
