...
/**
 * Lets a shopper edit the medicines on their next subscription delivery and
 * stop future renewals. Editing only applies to a pending delivery, which is
 * the one at the head of the renewal chain.
 */
export default function SubscriptionManager({ subscription, onChanged }) {
  ...
  // Mirror of Order::canCancelSubscription() so the button explains itself
