...
export default function PharmacistDetailCard({ pharmacist, onUpdateSuccess, onDeleteSuccess }) {
  ...
  const hours = Array.from({ length: 15 }, (_, i) => i + 9) // 9 AM to 11 PM (9–23)
  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        ...
        {/* Slot booking — anyone except the doctor themselves */}
        {canBook && (
          <div className={styles.section}>
        ...
        {isOwnProfile && isDoctor && (
          <div className={styles.section}>
            ...
            {/* View & delete own slots for selected date */}
